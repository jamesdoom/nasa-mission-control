...
- Local-first notes, tags, custom collections, saved filter views, and preview-first backup merge controls
...
61. **Complete — Spacecraft-inspired data presentation phase 3:** unified live-data controls, analysis charts, accessible tables, freshness telemetry, and async states; assigned APOD, NeoWs, DONKI, EPIC, and NASA Media distinct instrument signals; preserved semantic stale/error colors and reduced-motion behavior; and added deterministic identity, responsive, provenance, loading, error, and degraded-state evidence.
