...
| -------: | ---------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | ----: | ------------------------ | ----------------------------------------------------------------------------------------------------- |
|        1 | Preserve immersive asset headroom                    | Shared instrument consoles pass at 184.6/190 kB JavaScript and 24.8/26 kB CSS; independent visual systems would erode margin |   4.5 | Frontend maintainer      | Extend the shared instrument and surface tokens before adding route-specific visual code              |
