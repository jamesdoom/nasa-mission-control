...
| -------: | ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ----: | ------------------------ | ----------------------------------------------------------------------------------------------------- |
|        1 | Preserve immersive asset headroom                    | Cinematic records pass at 184.5/190 kB JavaScript and 24.1/26 kB CSS; independent visual systems would erode margin       |   4.5 | Frontend maintainer      | Reuse atmosphere and surface tokens before adding route-specific visual code                          |
