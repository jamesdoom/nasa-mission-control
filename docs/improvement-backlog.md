...
| -------: | ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ----: | ------------------------ | ----------------------------------------------------------------------------------------------------- |
|        1 | Preserve immersive asset headroom                    | The shared atmosphere passes at 184.1/190 kB JavaScript and 23.3/26 kB CSS; independent visual systems would erode margin |   4.5 | Frontend maintainer      | Reuse atmosphere and surface tokens before adding route-specific visual code                          |
