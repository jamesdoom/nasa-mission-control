...
- automated axe checks across 18 representative application states;
...
- The Phase 5 register requires owned evidence for keyboard, screen-reader,
  zoom/reflow, high-contrast, and reduced-motion review each month and release.
...
NVDA/Firefox or VoiceOver/Safari session notes were supplied. The Phase 5
register records zero manual screen-reader sessions and does not treat automated
semantic coverage as a substitute; that matrix remains part of the
