...
| ---: | ------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------- | ----------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|    1 | Mission Archive and comparison                         | 10 profiles; reviewed dates and at least two official sources per record       | Content reviewer          | Baseline complete | P1       | Strongest review controls. Active and extended status claims are time-sensitive; keep the existing status-dependent review cadence and re-read sources rather than treating link availability as verification.                |
|    2 | Space Trivia                                           | 12 questions; one question in every existing difficulty/channel combination    | Learning-content reviewer | Baseline complete | P1       | Thin for repeat sessions and lacks per-question verification dates. Phase 2 should expand within the four current channels, balance answer positions and difficulty, and add review metadata without creating categories.     |
|    3 | Live-data explanations                                 | APOD, asteroids, DONKI, EPIC, and NASA Media                                   | Science editor            | Baseline complete | P1       | Provenance and limitations are present, but copy is distributed across pages and shared components. Review terminology and units whenever a normalized contract changes; never imply that retrieval time is observation time. |
|    4 | Guided learning                                        | 3 tracks with objectives, checks, reflections, sources, and printable sessions | Learning-content reviewer | Baseline complete | P1       | Claims are source-backed, but tracks have no explicit review date. Human learning-effectiveness evidence remains incomplete and must not be inferred from technical accessibility tests.                                      |
|    5 | Scientific stories                                     | 3 collections with four chapters and four milestones each                      | Science editor            | Baseline complete | P1       | Each story has official sources and a review date. “Today” milestones need attention at every review because they can conceal changing mission status.                                                                        |
...
- **Source strength:** missions and stories carry review dates; trivia, learning tracks, guided paths, and scale profiles have official sources but need a common dated-review field or ledger.
...
Expand the existing trivia bank first. The target is at least 15–20 reviewed questions per existing channel, balanced across the existing three difficulties, with explanations that teach beyond the correct choice, official citations, verification dates, duplicate detection, and answer-position checks. No new channel, category, route, or product feature is implied.
