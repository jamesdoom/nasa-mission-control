...
|    2 | Space Trivia                                           | 96 questions; 24 in every existing channel, with eight cadet, nine specialist, and seven commander records | Learning-content reviewer | Phase 3 complete  | P2       | Every question has a teaching explanation, official NASA source, and review date. Integrity tests prevent duplicate prompts, answer bias, unreadable copy, and unstable wording.                                            |
...
|    8 | Investigation copy                                     | Existing structured mission relationships and DONKI comparisons                                            | Science editor            | Baseline complete | P2       | Mostly derived from reviewed records or normalized data. Keep “related” distinct from causal and “modeled” distinct from observed.                                                                                          |
...
- **Source strength:** missions, stories, and trivia carry review dates; learning tracks and guided paths have official sources but need a common dated-review field or ledger.
